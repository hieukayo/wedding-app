      ...
      <div className="ws">
        ...
        <div style={{}}>
          <div className="t6 text-base">
            ...
            <section data-widget="bio" className="t6-info">
              <div className="t6-container">
                ...
                <div className="t6-info-wrapper groom">
                  <p className="t6-info-title text-xl t6-text-brown">Chú rể</p>
                ...
                <div className="t6-info-wrapper bride">
                  <p className="t6-info-title text-xl t6-text-brown">Cô dâu</p>
                  <span className="t6-info-name text-5xl t6-text-secondary t6-font-secondary">
                    Nguyễn Hồng Nhân
                  </span>
                  <div className="t6-info-desc text-base t6-text-brown" />
            ...
            <div data-id="donate-fab" id="call-to-donate" style={{ bottom: 0 }}>
              <a>
                <div className="sticky-btn-wrapper">
                  <img
                    src="https://static.namtay.vn/assets/img/front.png"
                    className="sticky-btn-front"
                  />
                  <svg
                    width={86}
                    height={97}
                  ...
                  <img
                    src="https://static.namtay.vn/assets/img/back.png"
                    className="sticky-btn-back"
                  />{" "}
                  <img
                    src="https://static.namtay.vn/assets/img/button.png"
                    className="sticky-btn-button"
                  />{" "}
                  <img
                    src="https://static.namtay.vn/assets/img/money1.png"
                    className="sticky-btn-money1"
                  />{" "}
                  <img
                    src="https://static.namtay.vn/assets/img/money2.png"
                    className="sticky-btn-money2"
                  />{" "}
                  <img
                    src="https://static.namtay.vn/assets/img/money3.png"
                    className="sticky-btn-money3"
                  />
                </div>
              </a>
            </div>
            <section className="t6-footer">
              <div className="t6-container t6-footer-wrapper">
                <div className="t6-footer-content">
                  <span>Sản phẩm được tạo bởi</span>
                  <a href="https://namtay.vn?ref=" target="_blank">
                    <svg
                      width={111}
                      height={26}
                      viewBox="0 0 111 26"
                    ...
                    >
                      <path
                        d="M9.12655 10.9611C10.1778 12.0096 11.5476 12.518 12.9173 12.4862C14.2553 12.4862 15.5932 11.9778 16.6126 10.9611C17.186 10.3891 17.186 9.46772 16.6126 8.8958L12.9173 5.21013L12.4714 4.76529C9.60438 1.90571 4.98536 1.90571 2.15023 4.76529C-0.716745 7.62488 -0.716745 12.232 2.15023 15.0598C2.37322 15.2822 2.72363 15.2822 2.94662 15.0598L7.08781 10.9293C7.62935 10.3892 8.55316 10.3891 9.12655 10.9611Z"
                        fill="#FFFFFF"
                      />
                      <path
                        d="M27.7298 8.896L19.4793 0.666732C18.9059 0.0948134 17.9821 0.0948134 17.4087 0.666732L14.0639 4.00292C13.8409 4.22533 13.8409 4.57484 14.0639 4.79725L17.2494 7.97458C18.3325 9.05487 18.3325 10.8342 17.2494 11.9462C16.0389 13.1536 14.478 13.7255 12.9171 13.7573C11.3243 13.7573 9.73157 13.1536 8.48921 11.9462C8.26622 11.7238 7.91581 11.7238 7.69283 11.9462L4.37988 15.2189C3.80648 15.7908 3.80648 16.7122 4.37988 17.2841L11.834 24.7191C12.1207 25.005 12.5348 25.1639 12.9171 25.1321C13.2675 25.1321 13.6179 24.9733 13.9046 24.7191L27.7298 10.9295C28.3032 10.3893 28.3032 9.46792 27.7298 8.896Z"
                        fill="#FFFFFF"
                      />
                    </svg>
                  </a>
        ...
        <div
          data-app="true"
          id="app"
          className="v-application v-application--is-ltr theme--light"
        >
          <div className="v-application--wrap">
            <div
              role="dialog"
              data-fetch-key="data-v-1aa27156:0"
            ...
            <div
              role="dialog"
              data-fetch-key="data-v-2b7e83b0:0"
              className="v-dialog__container"
              data-v-2b7e83b0
            >
              {/**/}
            </div>{" "}
            <div role="dialog" className="v-dialog__container" data-v-cfe17980>
              {/**/}
            </div>{" "}
            <div
              role="dialog"
              ...
              data-v-3a358218
            />{" "}
            <div role="dialog" className="v-dialog__container" data-v-5877d829>
              {/**/}
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              <div data-v-3a358218 className="v-card v-sheet theme--light">
                <div data-v-3a358218 className="v-card__text donate-dialog">
                  <button
                    data-v-3a358218
                    type="button"
                    className="close-btn v-btn v-btn--icon v-btn--round theme--light v-size--default"
                  >
                  ...
                  <div data-v-3a358218 className="donate-input donate-error">
                    <input
                      data-v-3a358218
                  ...
                  <div
                    data-v-3a358218
                    className="donate-input mt-2 md:mt-5 donate-error"
                  >
                    <input
                      data-v-3a358218
                  ...
                  <div
                    ...
                    className="donate-input mt-2 md:mt-5 donate-error"
                  >
                    <div data-v-3a358218 className="tw-flex tw-items-center">
                      <input
                        data-v-3a358218
                        type="tel"
                        className="v-money"
                        placeholder="Số tiền mừng"
                        maxLength={10}
                      />{" "}
                      <div
                        data-v-3a358218
                        className="donate-amount-suffix nt-iserror"
                      >
                        <p
                          data-v-3a358218
                          className="tw-inline-flex tw-items-center"
                        >
                          .000 <span data-v-3a358218>đ</span>
                        </p>
                      </div>
                    </div>{" "}
                    {/**/}
                  </div>{" "}
                  <p data-v-3a358218 className="error-message">
                    true
                  </p>{" "}
                  <div data-v-3a358218 className="mt-2 md:mt-5 donate-input">
                    <div data-v-3a358218 className="mb-2 donate-input-label">
                      Bạn sẽ tham dự chứ?{" "}
                      <span data-v-3a358218 className="asterisk">
                        *
                      </span>
                    </div>{" "}
                    <div data-v-3a358218 className="rsvp">
                      <span data-v-3a358218>
                        <input
                          data-v-3a358218
                          id="nt-attendance-yes"
                          name="attendance"
                          type="radio"
                          defaultValue="true"
                        />{" "}
                        <label data-v-3a358218 htmlFor="nt-attendance-yes">
                          Tới luôn
                        </label>
                      </span>{" "}
                      <span data-v-3a358218>
                        <input
                          ...
                          name="attendance"
                          type="radio"
                          className="nt-donate-input"
                          defaultValue="false"
                        />{" "}
                        <label data-v-3a358218 htmlFor="nt-attendance-no">
                          Chưa chắc
                        </label>
                      </span>
                    </div>
                  ...
                  <div data-v-3a358218 className="donate-input mt-2 md:mt-5">
                    <textarea
                      data-v-3a358218
                      id="nt-donate-message-field"
                      placeholder="Lời chúc tới cô dâu chú rể"
                      className="nt-donate-form-input"
                      spellCheck="false"
                      data-ms-editor="true"
                      defaultValue={""}
                    />
                  ...
                  <div
                    data-v-3a358218
                    className="donate-payment-methods mt-2 md:mt-5"
                  >
                    <div data-v-3a358218 className="mb-2 tw-text-[12px]">
                      Mừng cưới qua{" "}
                      <span data-v-3a358218 className="asterisk">
                        *
                      </span>
                    ...
                    {/**/}{" "}
                    <div data-v-3a358218 className="method-wrapper">
                      <input
                        data-v-3a358218
                        id="donate-payment-method-1"
                        name="method"
                        type="radio"
                        defaultValue={1}
                      />{" "}
                      <label data-v-3a358218 htmlFor="donate-payment-method-1">
                        <img
                          data-v-3a358218
                          alt="payment-method-icon"
                          src="/_nuxt/img/qrcode.595d964.png"
                        />{" "}
                        <span data-v-3a358218>
                          <div data-v-3a358218>
                            Quét mã QR trên App Internet Banking
                          </div>{" "}
                          <div data-v-3a358218> (hỗ trợ 36 ngân hàng)</div>
                        </span>
                      </label>
                    </div>
                    <div data-v-3a358218 className="method-wrapper">
                      <input
                        data-v-3a358218
                        id="donate-payment-method-2"
                        name="method"
                        type="radio"
                        defaultValue={2}
                      />{" "}
                      <label data-v-3a358218 htmlFor="donate-payment-method-2">
                        <img
                          data-v-3a358218
                          alt="payment-method-icon"
                          src="/_nuxt/img/atm.16dd197.png"
                        />{" "}
                        <span data-v-3a358218>
                          <div data-v-3a358218>Nhập thông tin thẻ ATM</div>{" "}
                          <div data-v-3a358218>(hỗ trợ 36 ngân hàng)</div>
                        </span>
                      </label>
                    </div>
                    <div data-v-3a358218 className="method-wrapper">
                      <input
                        data-v-3a358218
                        id="donate-payment-method-3"
                        name="method"
                        type="radio"
                        defaultValue={3}
                      />{" "}
                      <label data-v-3a358218 htmlFor="donate-payment-method-3">
                        <img
                          data-v-3a358218
                          alt="payment-method-icon"
                          src="/_nuxt/img/visa.2af50a5.png"
                        />{" "}
                        <span data-v-3a358218>
                          <div data-v-3a358218>Thẻ Visa/Mastercard</div> {/**/}
                        </span>
                      </label>
                    </div>
                    <div data-v-3a358218 className="method-wrapper">
                      <input
                        data-v-3a358218
                        id="donate-payment-method-4"
                        name="method"
                        type="radio"
                        defaultValue={4}
                      />{" "}
                      <label data-v-3a358218 htmlFor="donate-payment-method-4">
                        <img
                          data-v-3a358218
                          alt="payment-method-icon"
                          src="/_nuxt/img/vnpay.0940aac.png"
                        />{" "}
                        <span data-v-3a358218>
                          <div data-v-3a358218>Ví điện tử VNPay</div> {/**/}
                        </span>
                      </label>
                    </div>
                  </div>
                </div>{" "}
                <div data-v-3a358218 className="v-card__actions dialog-footer">
                  <button
                    data-v-3a358218
                    type="button"
                    className="submit-btn v-btn v-btn--has-bg theme--light v-size--default"
                  >
                    <span className="v-btn__content">Mừng cưới ngay!</span>
                  </button>
                </div>
              </div>
            </div>
